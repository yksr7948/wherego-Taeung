...
public class GoogleLoginBean {
	private final static String GOOGLE_CLIENT_ID = "467100631012-ad3nc4fctun670g7e6n6aqqhat1bcdv8.apps.googleusercontent.com";
    private final static String GOOGLE_CLIENT_SECRET = "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";
    private final static String GOOGLE_REDIRECT_URI = "http://localhost:8888/wherego/google/callback";
