...
public class KakaoLoginBean {
	private final static String KAKAO_CLIENT_ID = "4ca6bd63ca63f7d303ebcae89947aedf";
    private final static String KAKAO_CLIENT_SECRET = "SkEpUNdHd0rDNhvdyY2H6kUh7hntQQc2";
    private final static String KAKAO_REDIRECT_URI = "http://localhost:8888/wherego/kakao/callback";
