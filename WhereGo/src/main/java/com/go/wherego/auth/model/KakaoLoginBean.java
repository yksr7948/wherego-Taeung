...
public class KakaoLoginBean {
	private final static String KAKAO_CLIENT_ID = "b553d7cad3bf3d40dd524ec8d7695fca";
    private final static String KAKAO_CLIENT_SECRET = "vqa3mmBupfWeUKU5cp5MQrZp1PcNYeXf";
    private final static String KAKAO_REDIRECT_URI = "http://localhost:8888/wherego/kakaocallback";
