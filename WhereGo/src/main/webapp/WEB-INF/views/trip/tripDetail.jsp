...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/tripDetail-style.css">
</head>
<body>
...
<main>
	...
	<script>
	    ...
	    function like() {
	    	...
	    	if(userId == ""){
	    		alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"로그인 후 사용 가능합니다.");
	    	}else if (likeYN) {
	    		...
	    		$.ajax({
	    			...
	    			success : function(result){
		    	        ...
		    	        heart.classList.add("far");
	        	        likeYN = false;
	        	        alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"좋아요를 취소하였습니다.");
	        	...
	        	$.ajax({
	        		...
	        		success : function(result){
						if(result >= 0){
		        	        ...
		        	        likeYN = true;
		        	        alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"좋아요!!");
		        	        $("#likeCount").text(result);
						}
	        		},
	        		error : function(){
    ...
    <script>
    	...
    	function insertReply(){
    		...
    		$.ajax({
    			...
    			success : function(result){
    				if(result > 0){
    					alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"댓글 작성 성공!");
						$("#content").val("");
						replyList();
    				}else{
    					alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"댓글 작성 실패 ㅠㅠ");
    				}
    			},
    			error : function(){
    				console.log("통신 실패");
     	...
     	function saveReply(replyNo){
     		...
     		$.ajax({
     			...
     			success : function(result){
     				...
     				alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"댓글 수정 성공!!");
     	     		$("#replyContent"+replyNo).css({"display":"block"});
     	     		$("#editContent"+replyNo).css({"display":"none"});
     	     		replyList();
     			},
     	...
     	function deleteReply(replyNo){
     		...
     		if(result){
     			$.ajax({
     				...
     				success : function(data){
     					if(data > 0){
     						alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"댓글 삭제 되었습니다.");
	     					replyList();
     					}else{
     						alertify.alert('<img src="resources/img/removebg-preview.png" style="width: 30px;">',"댓글 삭제 실패");
     					}
     				},
     				error : function(){
     					console.log("통신오류");
